@echo off
title Fabric Agentic Workspace Setup v0.6.0
echo.
echo  ===============================================
echo   Fabric Agentic Workspace -- One-click Setup v0.6.0
echo  ===============================================
echo.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Setup-FabricAgenticWorkspace.ps1"
echo.
pause
